 ...
 * Chat Log Component
 * 
 * Displays conversation transcript with messages from both user and agent.
 * Uses LiveKit's useSessionMessages hook for real-time message updates.
 * 
 * Based on LiveKit Components React patterns:
 * https://docs.livekit.io/frontends/start/frontends
 * 
 * Reference: agent-starter-react-native/app/assistant/ui/ChatLog.tsx
 */
